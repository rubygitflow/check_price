...
# # Delete CHECK_PRICE_DATABASE_URL from the environment, so it isn't accidently
# # passed to subprocesses.  CHECK_PRICE_DATABASE_URL may contain passwords.
# DB = Sequel.connect(ENV.delete('CHECK_PRICE_DATABASE_URL'), Settings.db&.to_hash&.compact! || {})
